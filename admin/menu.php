...
$adminmenu[3]['title'] = _MI_EFQDIR_ADMENU4;
$adminmenu[3]['link'] = "admin/fieldtypes.php";
$adminmenu[4]['title'] = _MI_EFQDIR_ADMENU5;
$adminmenu[4]['link'] = "admin/index.php?op=listNewListings";
$adminmenu[4]['icon'] = "images/prefs.png";
$adminmenu[4]['small'] = "images/prefs_small.png";
